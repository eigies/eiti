...
namespace eiti.Infrastructure.Migrations
{
    ...
    [Migration("20260913021559_AddCustomerIvaCondition")]
    partial class AddCustomerIvaCondition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eiti.Domain.Banks.Bank", b =>
                {
                    ...
                    b.Property<bool>("UseForCard")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("UseForCheque")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("UseForTransfer")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("eiti.Domain.Customers.CustomerCreditNote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("eiti.Domain.Quotes.Quote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ProspectContact")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("eiti.Domain.Quotes.QuoteDetail", b =>
                {
            ...
            modelBuilder.Entity("eiti.Domain.Suppliers.SupplierCreditNote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("eiti.Domain.Quotes.QuoteDetail", b =>
                {
                    b.HasOne("eiti.Domain.Quotes.Quote", null)
                        .WithMany("Details")
